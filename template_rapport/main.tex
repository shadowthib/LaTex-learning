...
\usepackage{lipsum}
\usepackage{tocloft}
%\usepackage{times} % Uncomment if you want to use Times font
...
% Formatage des titres des chapitres
\titleformat{\chapter}[hang]
    {\normalfont\huge\bfseries}{\thechapter}{1em}{} % Définit le style des chapitres
...
\begin{document}
%\raggedright % Evite de couper les mots en fin de ligne
